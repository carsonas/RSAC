...
ZonalStats_5Rows = read.table(zonalstats,header=T,nrows=5)
...
RF_Model = randomForest(Class~., data=ModelDataset,importance=TRUE,ntree=1000,classwt = c(1,500,300))
...
base = unlist(strsplit(OutputModel,split = "\\."))[1]
